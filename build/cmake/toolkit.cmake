...
if(WIN32)
    ...
    set(wxTOOLKIT_OPTIONS msw gtk2 gtk3 qt univ)
...
elseif(UNIX)
    set(wxPLATFORM UNIX)
    if(${CMAKE_SYSTEM_NAME} MATCHES "Emscripten" OR ${CMAKE_SYSTEM_NAME} MATCHES "Android")
        set(wxDEFAULT_TOOLKIT wasm)
        set(wxBUILD_TOOLKIT wasm)
...
elseif(wxBUILD_TOOLKIT MATCHES "qt")
    set(WXQT ON)
elseif(WXBUILD_TOOLKIT MATCHES "wasm")
    set(WXWASM ON)
    set(wxBUILD_WIDGETSET "univ")
endif()
...
if(UNIX AND NOT APPLE AND NOT WIN32 AND NOT ${CMAKE_SYSTEM_NAME} MATCHES "Emscripten" AND NOT ${CMAKE_SYSTEM_NAME} MATCHES "Android")
