...
if(WXWASM)
    ...
    wx_string_append(wasm_opts " -s PROXY_TO_PTHREAD=1")
    ...
    wx_string_append(CMAKE_EXE_LINKER_FLAGS " --source-map-base https://localhost/wx/build-minwasm/lib/")
    wx_string_append(CMAKE_EXE_LINKER_FLAGS ${wasm_opts})
    wx_string_append(CMAKE_EXE_LINKER_FLAGS " -s EXIT_RUNTIME=0")
endif()
